        ...
        if (userInfo !== null) {
            return (
                <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
                    <Text style={{ fontSize: 35, fontWeight: "bold", marginBottom: 20, color: "#3DCAA6"}}>
                        Welcome
                    </Text>
                    {userInfo?.picture && (
                    <Image source={{ uri: userInfo?.picture }} style={styles.image} />
                    )}   
                    <Text style={{ fontSize: 25, fontWeight: "bold", marginTop: 20, marginBottom: 20, color: "#3DCAA6" }}>{userInfo.name}</Text>
